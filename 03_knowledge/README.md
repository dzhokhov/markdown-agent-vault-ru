...
Переиспользуемые знания, методологии и справочные материалы.

## Детали

- [Методология маршрутизации задач](./task-routing-methodology-2026-04.md)
- [Методология исследований](./llm-research-methodology.md)
- [Системные полевые заметки](./research-systematic-field-notes-methodology.md)
